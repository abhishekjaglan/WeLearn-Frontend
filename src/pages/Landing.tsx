    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-primary to-neutral">
      ...
      <main className="flex-1 flex items-center justify-center pt-24 pb-16">
        <div className="text-center px-4">
          <div className="w-72 h-72 bg-accent rounded-full mx-auto mb-8 flex items-center justify-center text-white text-2xl font-semibold">
            Illustration Here
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              ...
              <h4 className="text-xl font-medium text-text mb-2">Documents</h4>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              <div className="text-4xl mb-4">🎧</div>
              <h4 className="text-xl font-medium text-text mb-2">Audio/Video</h4>
              <p className="text-sm text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              <div className="text-4xl mb-4">🔗</div>
              <h4 className="text-xl font-medium text-text mb-2">URLs</h4>
              <p className="text-sm text-gray-600">
